...
Mat generateDisparityMap(Mat& left, Mat& right) {
    ...
    if(disparity_method == 0)
    {
        cout<<"disparity_method: "<<disparity_method<<endl;
...
int main(int argc, char** argv) {
  ...
  static struct poptOption options[] = 
  {
    ...
    { "disparity_method",'m',POPT_ARG_INT,&method,0,"m=0: elas; m=1: opencv:","NUM" },
    POPT_AUTOHELP
